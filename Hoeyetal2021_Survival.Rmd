...
loo::loo_compare(mod.brm1,  mod.brm3, criterion = "loo")
...
loo::loo_compare(mod.brm.2,  mod.brm.3,mod.brm.4, mod.brm.5, mod.brm.6,mod.brm.7,mod.brm.8, criterion = "loo")
...
ggsave("Figures/GrazingPooled.png", plot = g, device = "png", 
       width = 6, height = 5, dpi=300)
ggsave("Figures/GrazingPooled.tiff", plot = g, device = "tiff", 
       width = 6, height = 5, dpi=300)
...
g = egg::ggarrange(pESa, pESb,pPOa, pPOb,
                pCSa, pCSb,ncol=2,nrow = 3, widths = c(1.4,1),heights = c(1.5, 1.5,1))
